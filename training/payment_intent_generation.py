...
async def main():
    ...
    payment_related_ms_gen_prompt = prompt_mgr.get_prompt("payment_related_no_seed")
    ...
    for i in range(num_of_calls):
        ...
        formatted_prompt = payment_related_ms_gen_prompt.format(
            count=examples_per_call,
            # relationships=seeds[seed_index]['relationships'],
            # topics=seeds[seed_index]['topics'],
        )
